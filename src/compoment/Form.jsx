...
const Form = () => {
  ...
  const [data,setData]=useState([
    ...
    {"description":"varsovie 1983. Le fils d’une militante proche de Solidarność est battu à mort par la police. Mensonges menaces : le régime totalitaire du Général Jaruzelski va tenter par tous les moyens d’empêcher la tenue d’un procès équitable.","title":"Varsove 83, une affaire d' état","trailer":"https://www.youtube.com/watch?v=h4XIRwrx6iI","posteUrl":"https://klubcinema.fr/sites/cineklub.fr/files/styles/kinepolis_filter_movie_poster/public/posters/Varsovie83_FRFO.jpg","rating":5}
  ])
